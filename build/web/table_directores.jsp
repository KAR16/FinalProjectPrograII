<%--
    Document   : table_directores
    Created on : 29 oct. 2021, 17:24:19
    Author     : Home
--%>
...
<body>
    ...
    <div class="container px-lg-5">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text">
          <li class="nav-item"><a class="nav-link active" aria-current="page" href="home.jsp">Inicio</a></li>
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5"><i class="bi bi-person-lines-fill"></i>&nbsp;&nbsp;Directores&nbsp;&nbsp;&nbsp;&nbsp;<a
          style="background-color:#ffc107;color: #212529;" class="btn btn-primary btn-sm"
          href="form_agregar_director.jsp">Agregar Director &nbsp; <i class="bi bi-person-plus"></i></a></h2>
        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
            ...
            <tr scope="row">
              ...
              <td>
                <a href="form_actualizar_director.jsp?id=<%=conexion.rs.getInt("ID_DIRECTOR")%>" class="more size-icon"><i class="bi bi-pencil-square"></i></a>
                <a href="form_eliminar_director.jsp?id=<%=conexion.rs.getInt("ID_DIRECTOR")%>" class="more size-icon">&nbsp;&nbsp;<i
