<%--
    Document   : form_eliminar_institucion
    Created on : 29 oct. 2021, 18:46:03
    Author     : Home
--%>

<%@page import="Institucion.Conectar_Eliminar"%>
...
<body>
  <%
      int p_id_institucion = Integer.parseInt(request.getParameter("id"));
      Conectar_Eliminar conexion_eliminar = new Conectar_Eliminar(p_id_institucion);
  %>
    <div class="registration-form">
      ...
      %>
        <form name="Form_actualizar" method="POST">
            ...
            <h3 style="text-align: center;margin-bottom: 50px;">Eliminar Institución</h3>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_institucion" value="<%=conexion_eliminar.rs.getInt("ID_INSTITUCION")%>" required>
            </div>
            <div class="form-group">
...
<%
    ...
    if (spar_id_institucion != null && spar_nombre != null) {
        ...
        conexion_eliminar.implementacion_eliminar(par_id_institucion, spar_nombre);
