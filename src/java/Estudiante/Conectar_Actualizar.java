...
public class Conectar_Actualizar {
    ...
    public void implementacion_actualizar(int id_estudiante, String nombre, String direccion, int edad) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.ESTUDIANTES SET NOMBRE='" + nombre + "',DIRECCION='" + direccion + "',EDAD=" + edad + " WHERE ID_ESTUDIANTE=" + id_estudiante);
        ps.executeUpdate();
