...
public class Conectar_Eliminar {
    ...
    public void implementacion_eliminar(int id_director, String nombre, String direccion) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.DIRECTORES SET NOMBRE='" + nombre + "',DIRECCION='" + direccion  + "',ESTADO=" + 0 + " WHERE ID_DIRECTOR=" + id_director);
        ps.executeUpdate();
