...
public class Conectar_Eliminar {
    ...
    public void implementacion_eliminar(int id_catedratico, String nombre, String direccion) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.CATEDRATICOS SET NOMBRE='" + nombre + "',DIRECCION='" + direccion  + "',ESTADO=" + 0 + " WHERE ID_CATEDRATICO=" + id_catedratico);
        ps.executeUpdate();
