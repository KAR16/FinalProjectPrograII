...
public class Conectar_Actualizar {
    ...
    public void implementacion_actualizar(int id_sede, int id_director, int id_estudiante, String direccion) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.SEDES SET ID_DIRECTOR=" + id_director +",ID_ESTUDIANTE="+ id_estudiante +",DIRECCION='" + direccion + "' WHERE ID_SEDE=" + id_sede);
        ps.executeUpdate();
