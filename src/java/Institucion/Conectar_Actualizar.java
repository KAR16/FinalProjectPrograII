...
public class Conectar_Actualizar {
    ...
    public void implementacion_actualizar(int id_institucion, String nombre) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.INSTITUCIONES SET NOMBRE='" + nombre + "' WHERE ID_INSTITUCION=" + id_institucion);
        ps.executeUpdate();
