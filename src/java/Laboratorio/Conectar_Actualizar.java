...
public class Conectar_Actualizar {
    ...
    public void implementacion_actualizar(int id_laboratorio, int id_curso, String nombre) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.LABORATORIOS SET ID_CURSO=" + id_curso + ",NOMBRE='" + nombre + "' WHERE ID_LABORATORIO=" + id_laboratorio);
        ps.executeUpdate();
