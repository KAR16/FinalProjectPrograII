...
public class Conectar_Actualizar {
    ...
    public void implementacion_actualizar(int id_facultad, int id_sede, String nombre) throws SQLException {

        ps = conect.prepareStatement("UPDATE dbo.FACULTADES SET ID_SEDE=" + id_sede + ",NOMBRE='" + nombre + "' WHERE ID_FACULTAD=" + id_facultad);
        ps.executeUpdate();
