...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5"><i class="bi bi-laptop"></i>&nbsp;&nbsp;Laboratorios&nbsp;&nbsp;&nbsp;&nbsp;<a
          style="background-color:#ffc107;color: #212529;" class="btn btn-primary btn-sm"
          href="form_agregar_laboratorio.jsp">Agregar Laboratorio &nbsp; <i class="bi bi-person-plus"></i></a></h2>
        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
            ...
            <tr scope="row">
              ...
              <td>
                <a href="form_actualizar_laboratorio.jsp?id=<%=conexion.rs.getInt("ID_LABORATORIO")%>" class="more size-icon"><i class="bi bi-pencil-square"></i></a>
                <a href="form_eliminar_laboratorio.jsp?id=<%=conexion.rs.getInt("ID_LABORATORIO")%>" class="more size-icon">&nbsp;&nbsp;<i class="bi bi-trash"></i></a>
              </td>
            </tr>
            <%}%>
          </tbody>
