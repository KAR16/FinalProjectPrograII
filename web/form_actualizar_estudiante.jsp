    ...
    <div class="registration-form">
      ...
      %>
        <form name="Form_actualizar" method="POST">
            ...
            <h3 style="text-align: center;margin-bottom: 50px;">Editar Estudiante</h3>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_estudiante" value="<%=conexion_act.rs.getInt("ID_ESTUDIANTE")%>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" class="form-control item" id="birth-date" placeholder="Edad" name="txt_edad" value="<%=conexion_act.rs.getInt("EDAD")%>" required>
            </div>
            <div class="form-group">
