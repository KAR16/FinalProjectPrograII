...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5"><i class="bi bi-person-workspace"></i>&nbsp;&nbsp;Estudiantes&nbsp;&nbsp;&nbsp;&nbsp;<a
          style="background-color:#ffc107;color: #212529;" class="btn btn-primary btn-sm"
          href="form_agregar_estudiante.jsp">Agregar Estudiante &nbsp; <i class="bi bi-person-plus"></i></a></h2>
        ...
        <table class="table table-striped custom-table">
          ...
          <tbody>
            ...
            <tr scope="row">
              ...
              <td>
                <a href="form_actualizar_estudiante.jsp?id=<%=conexion.rs.getInt("ID_ESTUDIANTE")%>" class="more size-icon"><i class="bi bi-pencil-square"></i></a>
                <a href="form_eliminar_estudiante.jsp?id=<%=conexion.rs.getInt("ID_ESTUDIANTE")%>" class="more size-icon">&nbsp;&nbsp;<i
