    ...
    <div class="registration-form">
        <form name="Form_insertar" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_laboratorio" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código Curso" name="txt_id_curso" required>
            </div>
            <div class="form-group">
