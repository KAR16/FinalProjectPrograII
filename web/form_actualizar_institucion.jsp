<%--
    Document   : form_actualizar_institucion
    Created on : 29 oct. 2021, 18:33:48
    Author     : Home
--%>

<%@page import="Institucion.Conectar_Actualizar"%>
...
<body>
  <%
      ...
      Conectar_Actualizar conexion_act = new Conectar_Actualizar(p_id_institucion);
  %>
    ...
    <div class="registration-form">
      ...
      %>
        <form name="Form_actualizar" method="POST">
            ...
            <h3 style="text-align: center;margin-bottom: 50px;">Editar Institución</h3>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_institucion" value="<%=conexion_act.rs.getInt("ID_INSTITUCION")%>" required>
            </div>
            <div class="form-group">
...
<%
    ...
    if (spar_id_institucion != null && spar_nombre != null) {
        ...
        conexion_act.implementacion_actualizar(par_id_institucion, spar_nombre);
