    ...
    <div class="registration-form">
      ...
      %>
        <form name="Form_actualizar" method="POST">
            ...
            <h3 style="text-align: center;margin-bottom: 50px;">Editar Sede</h3>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_sede" value="<%=conexion_act.rs.getInt("ID_SEDE")%>" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código Director" name="txt_id_director" value="<%=conexion_act.rs.getInt("ID_DIRECTOR")%>" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código Institución" name="txt_id_estudiante" value="<%=conexion_act.rs.getInt("ID_ESTUDIANTE")%>" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="password" placeholder="Dirección" name="txt_direccion" value="<%=conexion_act.rs.getString("DIRECCION")%>" required>
            </div>
            <div class="form-group">
