    ...
    <div class="registration-form">
      ...
      %>
        <form name="Form_eliminar" method="POST">
            ...
            <h3 style="text-align: center;margin-bottom: 50px;">Eliminar Facultad</h3>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código" name="txt_id_facultad" value="<%=conexion_eliminar.rs.getInt("ID_FACULTAD")%>" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control item" id="username" placeholder="Código Sede" name="txt_id_sede" value="<%=conexion_eliminar.rs.getInt("ID_SEDE")%>" required>
            </div>
            <div class="form-group">
