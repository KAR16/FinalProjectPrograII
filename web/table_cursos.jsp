...
<body>
  ...
  <div class="content">
    ...
    <div class="container">
      <h2 class="mb-5"><i class="bi bi-journal-text"></i>&nbsp;&nbsp;Cursos&nbsp;&nbsp;&nbsp;&nbsp;<a
          style="background-color:#ffc107;color: #212529;" class="btn btn-primary btn-sm"
          href="form_agregar_curso.jsp">Agregar Curso &nbsp; <i class="bi bi-person-plus"></i></a></h2>
        ...
        <table class="table table-striped custom-table">
          <thead>
            <tr>
              ...
              <th scope="col">Código Catedrático</th>
          ...
          <tbody>
            ...
            <tr scope="row">
              ...
              <td>
                <a href="form_actualizar_curso.jsp?id=<%=conexion.rs.getInt("ID_CURSO")%>" class="more size-icon"><i class="bi bi-pencil-square"></i></a>
                <a href="form_eliminar_curso.jsp?id=<%=conexion.rs.getInt("ID_CURSO")%>" class="more size-icon">&nbsp;&nbsp;<i
